      ...
      <div className="wrapper text-center text-white flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p data-aos="fade-up" className="desc max-w-[50rem] mx-auto">
            At Allurecent Software Solutions, we believe in the power of
            innovation and excellence to drive growth and success for our
            clients. Our core values are at the heart of everything we do:
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-5 mt-9">
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  ...
                  approaches to solve problems and drive business success.
                </p>
              </div>
              <div
                data-aos="fade-right"
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  ...
                  clients and each other to achieve the best results.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                <div className="flex w-full text-start items-center justify-between gap-3">
                  <h5 className="text-xl">Excellence</h5>
                  <img
                ...
                <p className="desc text-white/80 text-start mt-3">
                  Quality is at the core of everything we do. We strive for
                  perfection in every project we undertake, ensuring the best
              ...
              >
                <div className="flex w-full text-start items-center justify-between gap-3">
                  <h5 className="text-xl">Customer Focus</h5>
                  <img
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We are deeply invested in our clients' success. Understanding
                  your needs and delivering solutions that drive your business
                  forward is our top priority.
                </p>
              </div>
            </div>
          </div>
